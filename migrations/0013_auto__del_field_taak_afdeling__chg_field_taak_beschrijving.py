...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Taak.beschrijving'
        db.alter_column('bestuursmodel_taak', 'beschrijving', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Adding field 'Taak.afdeling'
        db.add_column('bestuursmodel_taak', 'afdeling',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='taken', null=True, to=orm['bestuursmodel.Afdeling'], blank=True),
                      keep_default=False)


        # Changing field 'Taak.beschrijving'
        db.alter_column('bestuursmodel_taak', 'beschrijving', self.gf('django.db.models.fields.TextField')(default='x'))

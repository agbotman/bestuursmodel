...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('bestuursmodel_taak', 'rol',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bestuursmodel.Taak'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'bestuursmodel.taak': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'naam': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '45'}),
            'rol': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bestuursmodel.Taak']", 'null': 'True', 'blank': 'True'})
        },
